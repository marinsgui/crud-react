function App() {
  ...
  return (
    <main className="h-[94vh] flex justify-center items-center bg-slate-300">
      <form className="flex flex-col justify-center gap-3 w-96 p-8 bg-white rounded shadow-md">
